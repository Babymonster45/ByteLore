...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Get user input from the forgot username form
    $email = $_POST["email"];

    // Initialize separate error arrays for Email
    $emailErrors = array();
    ...
    if ($checkEmailStmt->num_rows > 0) {
        ...
        $resetLink = "https://bytelore.cheeseindustries.net/reset_username.php?token=$resetToken";
        $verification_message = "Here is your username reset link! Please click the following link to verify your account: <a href='$resetLink'>$resetLink</a>";
