            ...
            <div class="col-lg-8">
                <div class="call-action-content text-center">
                    ...
                    <p class="text">
                        ...
                        discover new games and join the conversation.<br><br>
                        Check out our recently added games below, or our game list above!
                    </p>
                </div>
                <!-- call action content -->
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="call-action-content text-center">
                    <br>
                    <h2 class="action-title">Anything Missing? Add A Game!</h2><br>
                    <?php
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="call-action-content text-center">
                    <br><br>
                    <h2 class="action-title">Recently Added Games</h2>
                </div>
            </div>
